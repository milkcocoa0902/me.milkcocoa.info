...
## 第2条（個人情報の収集方法）
当社は, 運営するアプリの改善のために匿名で情報を収集する場合があります。ただし, 必要性が認められた際には, 個人が特定できる情報を請求する可能性があります。  
なお, 収集した情報はこれのみに使用され, また, 利用後には速やかに破棄するものとします。
